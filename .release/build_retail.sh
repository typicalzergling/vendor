...
$JUNCTION_TOOL "$addon_path" "beta\\$ADDON_NAME"
$JUNCTION_TOOL "$addon_path_rulepack" "beta\\$addon_rulepack"
$JUNCTION_TOOL "$addon_path_ark" "beta\\$addon_ark"
$JUNCTION_TOOL "$addon_path_adi" "beta\\$addon_adi"
$JUNCTION_TOOL "$addon_path_tsm" "beta\\$addon_tsm"
$JUNCTION_TOOL "$addon_path_pawn" "beta\\$addon_pawn"