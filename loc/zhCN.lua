...
RULEUI_SELL_EPIC_INFO = "出售所有" ..ITEM_QUALITY_COLORS[4].hex .. "史诗|r装备-物品等级低于",
RULEUI_SELL_RARE_INFO = "出售所有" ..ITEM_QUALITY_COLORS[3].hex .. "精良|r装备-物品等级低于",
RULEUI_SELL_UNCOMMON_INFO = "出售所有" ..ITEM_QUALITY_COLORS[2].hex .. "优秀|r装备-物品等级低于",
RULEUI_KEEP_EPIC_INFO = "保留所有" ..ITEM_QUALITY_COLORS[4].hex .. "史诗|r装备-物品等级高于",
RULEUI_KEEP_RARE_INFO = "保留所有" ..ITEM_QUALITY_COLORS[3].hex .. "精良|r装备-物品等级高于",
RULEUI_KEEP_UNCOMMON_INFO = "保留所有" ..ITEM_QUALITY_COLORS[2].hex .. "优秀|r装备-物品等级高于",
