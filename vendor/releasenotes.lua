...
Addon.ReleaseNotes = {
{
    ...
    on ="June 29, 2021",
    content = {
        { type="header", text = "Classic / TBC Compat updates" },
        [[It appears as though Blizzard has advanced their Classic and TBC UI to no longer have some of the previous incompatibilites. So with some minor adjustments this version of Vendor should now work on TBC and Classic]],
        ...
        { type = "header", text = "Systems Improvements" },
        [[While there are no outward features yet exposed related to improving the systems of Vendor, a fair bit has changed, which may mean new unexpected bugs. Features that use some of the new improvements will be forthcoming.]],
        { type="header",  text="Updated Item Property - IsCraftingReagent" },
        [[Now uses the GetItemInfo property which tracks this instead of trying to read it from the tooltip.]],
        { type="header", text="Notable Bug Fixes" },
...

{
    ...
    content = 
{
{ type="header", text="AdiBags Plugin" },
[[
    Similar to the ArkInventory plugin, we now have an AdiBags plugin that adds categories for items Vendor will Sell or Destroy to AdiBags.
]],
[[
...
{ type="header", text="Audit Tab" },
[[
    All items Vendor sells or destroys in the last 30 days is now tracked and available for viewing in the new Audit tab.
]],
[[
    If you think Vendor may have sold or destroyed something, check the Audit tab! If you need to use Blizzard item restoration, this information can be very useful in locating when the item was sold or destroyed. It will also tell you why it was sold/destroyed and what Vendor Rule was used to make that determination.
]],
[[
    There are also new console commands for showing the Vendor History, under "/vendor history". You can reset the history for a character or all characters using "/vendor history clear" and "/vendor history clear all".
]],
[[
...
{ type="header", text="New Built-in Keep Rule - Potential Upgrades" },
[[
...
{ type="header", text="Unsellable Items added to the Sell list" },
[[
...
{ type="header", text="New Item Property - IsEquipped" },
[[
