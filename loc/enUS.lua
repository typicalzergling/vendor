...
["OPTIONS_SETTINGNAME_DEBUGRULES"] = "Rule Debugging",
["OPTIONS_SETTINGDESC_DEBUGRULES"] = "Toggles debugging mode for rules This will output LOTS of messages to console.",
...
["SYSRULE_SELL_ALWAYSSELL"] = "Always sell items",
...
["SYSRULE_SELL_RARE_ITEMS_DESC"] = "Matches souldbound rare (rate) weapons and armor with an item level less than specified item level",
["SYSRULE_SELL_EPIC_ITEMS"] = "Epic Items",
["SYSRULE_SELL_EPIC_ITEMS_DESC"] = "Matches souldbound epic (purple) weapons and armor with an item level less than specified item level",

["SYSRULE_KEEP_NEVERSELL"] = "Never sell item",
["SYSRULE_KEEP_NEVERSELL_DESC"] = "Matches the item ID against the never sell list",
["SYSRULE_KEEP_COMMON"] = "Common (white) items",
["SYSRULE_KEEP_COMMON_DESC"] = "Matches any common (white) item typically these have some value, for example crafting reagents",
["SYSRULE_KEEP_UNCOMMON"] = "Uncommon items|r",
["SYSRULE_KEEP_UNCOMMON_DESC"] = "Matches any uncommon (green) item",
["SYSRULE_KEEP_RARE"] = "Rare Items",
["SYSRULE_KEEP_RARE_DESC"] = "Matches any rare (blue) item",
["SYSRULE_KEEP_EPIC"] = "Epic Items",
["SYSRULE_KEEP_EPIC_DESC"] = "Matches any epic (purple) item",
["SYSRULE_KEEP_LEGENDARY"] = "Legendary Items",
["SYSRULE_KEEP_LEGENDARY_DESC"] = "Matches any legenedary item",
["SYSRULE_KEEP_ARTIFACT"] = "Artifact Items",
["SYSRULE_KEEP_ARTIFACT_DESC"] = "Matches any artifact item",
["SYSRULE_KEEP_HEIRLOOM"] = "Heirloom Items",
["SYSRULE_KEEP_HEIRLOOM_DESC"] = "Matches any heirloom item",
["SYSRULE_KEEP_TOKEN"] = "WoW Tokens",
["SYSRULE_KEEP_TOKEN_DESC"] = "Matches any WoW tokens in your inventory and prevetns them from being sold",
["SYSRULE_KEEP_UNKNOWNAPPERANCE"] = "Unknown Apperance",
["SYSRULE_KEEP_UNKNOWNAPPERANCE_DESC"] = "Matches any item which is bind on equip item which is appearance unknown to you",
